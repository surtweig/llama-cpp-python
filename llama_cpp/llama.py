...
class Llama:
    ...
    def __init__(
        ...
        **kwargs,  # type: ignore
        ...
        self.inference_stopped = threading.Event()
    ...
    def _create_completion(
        ...
        if len(self._scores) > 0 and finish_reason is not "abort" and stopping_criteria is not None and stopping_criteria(
